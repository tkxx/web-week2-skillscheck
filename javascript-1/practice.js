...
let myNumbersIndex = [];
let forIndividual = myNumbers.forEach(function (element, i, array) {
...
let enemies = people.filter(function(people, index, array) {
...
let totallyAwesome = people.reduce(function(total, people, index, array){
	return total += people.awesomeLevel;
}, 0);
